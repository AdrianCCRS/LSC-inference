"""
LSC Real-Time Inference Script
================================
...
Soporta los 5 modelos entrenados en el notebook:
  ...
  - GCN (HandGCNv2)            (PyTorch Geometric, node_dim=7)
  - GAT (HandGAT)              (PyTorch Geometric, node_dim=7 + edge_attr)
...
Preprocesamiento exactamente igual al entrenamiento:
  ...
  6. Para modelos de grafo: construir node_features (7-dim por nodo)
...
Uso:
  ...
  python lsc_inference_realtime.py --model gcn --artifacts model_artifacts_kaggle
  python lsc_inference_realtime.py --model mlp --artifacts model_artifacts_kaggle
...
def build_node_features(coords_normalized, edges_undirected, base_connections=None):
    """
    Construye node_features de dimension 7 por nodo:
      [x, y, z,  bone_vec_x, bone_vec_y, bone_vec_z,  dist_center]

    Identico a build_features() del notebook.
    """
    ...
    node_features = np.concatenate([c, bone_vecs, dist_center], axis=1)  # (21,7)
